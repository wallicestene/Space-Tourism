...
const Home = () => {
  return (
    <div className='md:bg-[url(/assets/home/background-home-desktop.jpg)] bg-[url(/assets/home/background-home-tablet.jpg)] bg-cover h-screen text-white overflow-scroll relative'>
      ...
      <div className="grid md:grid-cols-2 grid-col-1 md:gap-10 place-items-center h-screen text text-center md:text-start">
        <div className="left md:w-4/5 p-5">
          <h1 className=' font-barlow-400 md:text-xl mb-5 text-gray-400'>So You Want To Travel To</h1>
          <h1 className=' font-barlowcondensed text-9xl mb-5'>SPACE</h1>
        ...
        <div className="right md:grid place-items-center">
          <Link to="/destination">
